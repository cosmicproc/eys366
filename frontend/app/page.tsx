...
import { getNodes } from "./lib/apiClient";
  ...
  const quickActions =
    user.role === "head"
      ? [
          {
            title: "View Graph",
            description: "Visualize course and program outcomes",
          ...
          },
          {
            ...
            description: "Manage lecturers and program structure",
          ...
          },
          {
            ...
            description: "Access all courses in the program",
            icon: <IconBook size={24} />,
            color: "teal",
            onClick: () => {
              if (user.courseIds?.[0]) {
                router.push(`/graph?courseId=${user.courseIds[0]}`);
              }
            },
          },
          {
            title: "Analytics",
            description: "View program-wide analytics",
      ...
      : [
          {
            title: "View Graph",
            description: "Visualize your course outcomes",
            icon: <IconGraph size={24} />,
            color: "blue",
            onClick: () => router.push("/graph"),
          },
          {
            title: "My Courses",
            description: "Access your assigned courses",
            icon: <IconBook size={24} />,
            color: "teal",
            onClick: () => {
              if (user.courseIds?.[0]) {
        ...
        <Group justify="space-between" mb="md">
          <div>
            ...
            <Group gap="xs">
              ...
              >
                {user.role === "head" ? "Department Head" : "Lecturer"}
              </Badge>
              {user.department && (
